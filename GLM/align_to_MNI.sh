...
REF=/data/opt/apps/fsl/6.0.4/data/standard/MNI152_T1_2mm_brain.nii.gz
    ...
    INFILE="results/GLM_Study/contrast_maps/${SUBJECT_ID}_pure_late_early.nii.gz"
    OUTFILE="results/GLM_Study/contrast_maps/${SUBJECT_ID}_pure_late_early_MNI.nii.gz"
...
#    TRANSFORM="../../R01-fmri/fmriprep_pepolar/sub-${SUBJECT_ID}/anat/sub-${SUBJECT_ID}_from-T1w_to-MNI152NLin2009cAsym_mode-image_xfm.h5"
