...
parser.add_argument("--base_path", type=str, default="./sub-5160/betaseries/",
...
path = f"{args.base_path}/sub-{args.subject}/ses-1/func/"

files = []
runs = f'_{args.block_number}_runs'

for i in range(1,7):
	files.append(f'{path}sub-{args.subject}_ses-1_task-StimExposure_run-{i}_space-T1w_label-brain-mask_betaseries.nii.gz')
