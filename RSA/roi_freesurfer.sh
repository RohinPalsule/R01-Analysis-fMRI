...
fslmaths parcels.nii.gz -thr 17 -uthr 17 -bin l_hip.nii.gz
fslmaths parcels.nii.gz -thr 53 -uthr 53 -bin r_hip.nii.gz
fslmaths l_hip.nii.gz -add r_hip.nii.gz -bin b_hip.nii.gz

# putamen
fslmaths parcels.nii.gz -thr 12 -uthr 12 -bin l_put.nii.gz
fslmaths parcels.nii.gz -thr 51 -uthr 51 -bin r_put.nii.gz
fslmaths l_put.nii.gz -add r_put.nii.gz -bin b_put.nii.gz
